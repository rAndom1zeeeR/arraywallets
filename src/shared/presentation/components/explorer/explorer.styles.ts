...
export const explorerStyles = {
  ...
  content: "flex flex-1 flex-col gap-4 px-0 py-0 sm:px-8 sm:py-6 lg:flex-row lg:gap-6 lg:px-8",
  ...
  tabList:
    "flex gap-0 overflow-y-hidden overflow-x-auto border-b border-border scrollbar-thin-x [-webkit-overflow-scrolling:touch]",
  tabPanel: "min-w-0 overflow-x-visible lg:overflow-x-auto lg:scrollbar-table-x [-webkit-overflow-scrolling:touch]",
  tab: cn(
  ...
  tableGroup: "border-b border-border bg-background px-4 py-1.5 text-xs font-semibold text-muted-foreground",
  tableRow:
  ...
  directionIcon: "flex size-8 shrink-0 items-center justify-center rounded-xl bg-explorer-surface-2",
...
export const explorerHeaderStyles = {
  ...
  search: "hidden w-64 items-center gap-2 rounded-lg border border-border bg-explorer-surface-2 px-3 py-1.5 sm:flex",
  iconButton:
