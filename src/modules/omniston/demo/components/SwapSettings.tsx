...
import { Chain, EVM_CHAINS } from "@/modules/omniston/demo/models/chain";
...
import { Label } from "@/modules/omniston/demo/components/ui/label";
  ...
  return (
    <section className="flex items-center gap-2">
      ...
      <Switch
        ...
        onCheckedChange={(checked: boolean) => setFlexibleIntegratorFee(checked)}
      />
    </section>
  );
};
